...
const singletonTypes = ["homePageSettings", "aboutPageSettings", "photographer", "siteSettings"];
...
export default defineConfig({
  ...
  document: {
    newDocumentOptions: (previous, { creationContext }) => {
      ...
      return previous.filter((templateItem) => !singletonTypes.includes(templateItem.templateId));
    },
